      ...
      >
        <div className="absolute inset-0 bg-gray-900/50 flex items-center justify-center">
          <div className="text-center text-white space-y-4 animate-fadeIn">
            ...
            <a href="#meet">
              <button
                className="mt-3 px-6  py-2 text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 rounded-md transition-all duration-300
        ...
        <div className="container mx-auto text-black py-10 flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
          <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-6 animate-slideIn">
            <div className="lg:w-1/2 space-y-6">
              ...
              <Link to={"/product"}>
                <button
                  className=" px-6 py-2 text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 rounded-md transition-all duration-300
                hover:-translate-y-0.5"
                >
                  Shop Now
                </button>
      ...
      <section className="my-10 px-4 md:px-0 " data-aos="flip-left">
        ...
        <div className="container mx-auto text-black py-10 flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
          ...
          <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <Link to="/product">
              <button className="mt-3 px-6 py-2 text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 rounded-md transition-all duration-300  hover:-translate-y-0.5">
                Order Now
              </button>
            </Link>
          </div>
