          ...
          <div className="relative bg-white p-6 rounded-lg shadow-lg w-full max-w-lg mx-4 md:mx-auto">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end mt-6">
                ...
                <button
                  type="submit"
                  className="px-4 w-full sm:py-0 md:py-2 py-2 text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 rounded-md transition-all duration-300
                   hover:-translate-y-0.5"
                >
                  Submit
                </button>
