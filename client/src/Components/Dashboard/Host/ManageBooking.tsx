                        ...
                        <td className="py-4 px-4 text-sm text-gray-600">
                          {listing?.hostIsApproved === "approve" ? (
                            ...
                            <button
                              ...
                              className="px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 rounded-md transition-all duration-300  hover:-translate-y-0.5"
                            >
                              approve
                            </button>
                          )}
