            ...
            <div className="max-w-xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden border border-gray-300 transform transition hover:scale-105 duration-300">
              ...
              <div className="mt-6 flex justify-between p-6">
                <Link to={`/updated-seller/${sellerData._id}`}>
                  <button
                    className="px-5  py-2 text-white bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-500/30 rounded-md transition-all duration-300
                ...
                <button
                  ...
                  className="px-4  py-2 text-white bg-gradient-to-r from-red-500 to-red-500 rounded-md transition-all duration-300
                   hover:bg-red-600 hover:border-red-400 hover:shadow-[0_0_15px_3px_rgba(99,102,241,0.7)] hover:scale-105"
                >
                  Delete
                </button>
              </div>
